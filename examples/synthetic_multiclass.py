...
def run_experiment() -> tuple[float, float, float, float]:
    ...
    # Build prediction sets on the test data.
...
def main() -> None:
    ...
    coverage, mean_set_size, automated_fraction, automated_error = results
